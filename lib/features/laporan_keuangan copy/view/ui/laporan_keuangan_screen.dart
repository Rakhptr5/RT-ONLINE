...
import 'package:venturo_core/features/laporan_keuangan%20copy/view/components/laporan_keuangan_card.dart';
import 'package:venturo_core/features/laporan_keuangan%20copy/view/components/top_bar_keuangan.dart';
...
class LaporanKeuanganAdminScreen extends StatelessWidget {
  LaporanKeuanganAdminScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    // List A
    List<LaporanKeuanganAdminCard> listDataWargaA = [];
    for (int i = 0; i < 5; i++) {
      listDataWargaA.add(
        const LaporanKeuanganAdminCard(
          profileBadge: "A-20",
          ...
          children: [
            ...
            Stack(
              ...
              children: [
                ...
                // Button Container
                Padding(
                  padding: const EdgeInsets.only(top: 120.0, left: 16),
                  child: TopBarLaporanKeuangan2(
                    text: "Oktober",
                  ),
                ),
              ],
              ...
              child: Obx(
                () => TabBar(
                  ...
                  tabs: <Widget>[
                    Tab(
                      child: buildTab(
                          text: "Pemasukan", text2: "Rp 2.500.000", index: 0),
                    ),
                    Tab(
                      child: buildTab(
                          text: "Pengeluaran", text2: "Rp 1.500.000", index: 1),
                    ),
                  ],
                ),
              ),
                  ...
                  children: <Widget>[
                    ...
                    ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return LaporanKeuanganAdminCard(
