...
class EditHakAksesPage extends StatefulWidget {
  final String id;
  final String name;

  EditHakAksesPage({required this.id, required this.name, Key? key})
      : super(key: key);

  @override
  _EditHakAksesPageState createState() => _EditHakAksesPageState();
}

class _EditHakAksesPageState extends State<EditHakAksesPage>
  ...
  String selectedCardName =
      ''; // Variabel untuk menyimpan nama card yang dipilih
                    ...
                    Container(
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          hintText:
                              selectedCardName, // Gunakan nilai variabel sebagai hintText
                          hintStyle: TextStyle(
                        ...
                        child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              return GestureDetector(
                                onTap: () {
                                  setState(() {
                                    selectedCardName = dataWarga[index]
                                        .akses; // Perbarui nilai variabel
                                  });
                                },
                                child: CheckList(
                                  ...
                                  onChanged: (value) {
                                    if (value != null) {
                                      if (value) {
                                        selectedAccess
                                            .add(dataWarga[index].akses);
                                      } else {
                                        selectedAccess.removeWhere((item) =>
                                            item == dataWarga[index].akses);
                                      }
                                    }
                                  },
                                ),
                        ...
                        child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              return GestureDetector(
                                onTap: () {
                                  setState(() {
                                    selectedCardName = informasi[index]
                                        .akses; // Perbarui nilai variabel
                                  });
                                },
                                child: CheckList(
                                  ...
                                  onChanged: (value) {
                                    if (value != null) {
                                      if (value) {
                                        selectedAccess
                                            .add(informasi[index].akses);
                                      } else {
                                        selectedAccess.removeWhere((item) =>
                                            item == informasi[index].akses);
                                      }
                                    }
                                  },
                                ),
                        ...
                        child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              return GestureDetector(
                                onTap: () {
                                  setState(() {
                                    selectedCardName = pengumuman[index]
                                        .akses; // Perbarui nilai variabel
                                  });
                                },
                                child: CheckList(
                                  ...
                                  onChanged: (value) {
                                    if (value != null) {
                                      if (value) {
                                        selectedAccess
                                            .add(pengumuman[index].akses);
                                      } else {
                                        selectedAccess.removeWhere((item) =>
                                            item == pengumuman[index].akses);
                                      }
                                    }
                                  },
                                ),
                ...
                child: GestureDetector(
                  onTap: () async {
                    Map<String, dynamic> response =
                        await putHak(widget.id, name, selectedAccess);
                    print(response);
